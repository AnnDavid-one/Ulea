 ...
 if(!selectedImage) {
  ...
  <View style={styles.container}>
     <View style={styles.header}>
       ...
       <Text style={{ fontWeight: "bold", color: "white" }}>New Post</Text>
     <View style={{ width: 28 }} />
     
      </View>

   <TouchableOpacity style={styles.emptyImageContainer} onPress={pickImage}>
    <Ionicons name="image-outline" size={68} color={COLORS.grey} />
...
>
  ...
  <View style={styles.contentContainer}>
      ...
      <View style={styles.header}>
        ...
        disabled={isSharing} // it'll be disabled if were in the loading state
        >
          <Ionicons name= "close-outline" size={28} color={isSharing ? COLORS.grey : COLORS.white} />


        </TouchableOpacity>
        <Text style={{ fontWeight: "bold", color: "white",  marginHorizontal:"auto"}}> New Post</Text>
        <TouchableOpacity
